...
export default function Installments() {
  ...
  return <Stack spacing={2}>
    ...
    {loading ? <TableSkeleton rows={5} /> : detail ? <>
      ...
      {list.rows.length === 0 ? <EmptyState icon={<EventRepeatRounded />} title="ยังไม่มีแผนผ่อน" description="เพิ่มราคาซื้อ เงินดาวน์ และจำนวนงวด เพื่อเห็นภาระทั้งหมดและติดตามยอดจ่าย" action={<Button variant="contained" onClick={openEditor}>เพิ่มแผนผ่อนแรก</Button>} /> : <TableContainer component={Paper} variant="outlined" tabIndex={0}><Table size="small" aria-label="แผนผ่อนทั้งหมด" sx={{ minWidth: 650 }}>
